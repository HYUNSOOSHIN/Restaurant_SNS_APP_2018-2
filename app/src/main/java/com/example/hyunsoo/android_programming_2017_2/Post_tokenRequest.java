...
public class Post_tokenRequest extends AsyncTask<JSONObject, Void, String> {
    Activity activity;
    URL url;

    public Post_tokenRequest(Activity activity) {
    ...
    protected String doInBackground(JSONObject... postDataParams) {
        ...
        try {
            ...
            String token = postDataParams[0].getString("token");
